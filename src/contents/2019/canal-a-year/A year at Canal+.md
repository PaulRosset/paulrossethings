...
<img class="mdImg" src="/2019/canal-a-year/c+.jpg">
...
From the beginning of its activities, the technological innovation, the excpetional freedom of expression for the era has contributed to consider Canal+ as an major actor of the television.
...
Canal+ soon became iconic of the french audiovision, with over 13 millions subscriber in France. However, they just have been catch up by netflix in France in term of number of subscribers.
...
Almost, at least a day in a week, there is a cool event that permit to see beyond our tech field and explore other possibilities given by the diversity of field in the company that always concern creativity.

One of them is the film screening during lunch time, It's really cool to watch movie that are not in theater yet.
...
To stand out from our challenger, we try to create the entertainment of today and tomorrow, and one of the point we want to try is the fact to not let the viewer passive in front of his TV but also active by adding features such as the Expert Mode, that permit to add extra information for a sport live event, such as the highlights of the game in case you missed a goal or see the differents angles of cameras for a formula one event.

Moreover, we recently added the multi live feature that allow you to watch until 4 different contents at the same time, its particularly useful to watch multiple sports event at the same time, no more excuses to do not watch you prefered team in England.  
...
<img class="mdImg" src="/2019/canal-a-year/expert-mode.png">

## A streaming universe

As I said earlier, Canal+ succesfully reinvented himself by putting innovation and technologie at first and it's still the case, I mean, it's really exiciting time to work for a streaming company nowadays, everydays a new challenger come knock our door.  
...
Thus, Canal+ is becoming a major actor when it comes to entertaining in France, still in the logic reinvented himself to progress on the market.
...
On the other hand, sometimes, its unfair, because the right in very country arent the same, and in France we have much more content protection video right than in other countries, so again the others actors of the sector possess here some advantages...
...
<div>
    <img class="mdImg" src="/2019/canal-a-year/netflix.png">
    <video src="/2019/canal-a-year/disney-plus.mp4" alt="disneyplus" autoplay controls></video>
</div>

## Web Player Team

<div>
    <img class="mdImg" src="/2019/canal-a-year/logoOnePlayer.png">
    <img class="mdImg" src="/2019/canal-a-year/rx.png"> 
</div>
...
But mostly we are maintaining 2 individual projects with one with **73 000** line of codes and another one with **48 000** lines whose one rely on the other.
...
It's a complex project that rely on multiple technologies as ffmpeg, DASH-MPEG, Smooth, DRM, ABR and many others. Its also open source, feel free to check it out [here](https://github.com/canalplus/rx-player).

The second one is called the **One Player**, it's a private project, its basically the UI of the player that integrate the **rx-player** and gather all the canal's web services.
...
It would be long to list all the features integrate in the player overall, but feel free to try it on [canal+](https://www.canalplus.com/)!
...
If you liked the post and want to know more, or maybe ask me a question, feel free to write me a line on my email post or by Twitter :)
